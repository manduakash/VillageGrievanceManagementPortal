...
<head>
    ...
    <title>Development Complaint | Gramin Sikayat Niwaran Portal</title>
                    ...
                    >
                      ...
                      <li class="nav-item menu-is-opening menu-open">
                        ...
                        <ul class="nav nav-treeview" style="display: block">
                          ...
                          <li class="nav-item">
                            <a href="development-complaint" class="nav-link active bg-primary">
        ...
        <div class="content-wrapper" style="min-height: 217.667px">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Raise Development Related Complaint</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="/">Home</a></li>
                                <li class="breadcrumb-item active">Development Complaint</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <section class="content">
                <form method="post" action="{{route('complaint.post')}}">
                    ...
                    <input type="hidden" class="@if($errors->has('complaint_type_id')) is-invalid @endif" name="complaint_type_id" value="3">    <!-- For Development Complaint -->
                </form>
            </section>
        </div>
