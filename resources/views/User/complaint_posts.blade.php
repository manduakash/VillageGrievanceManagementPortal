...
<html lang="en">
  <head>
    ...
    <title>Complaint Feed | Gramin Sikayat Niwaran Portal</title>
      ...
      <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-sm-inline-block">
            <a href="user-dashboard" class="nav-link">My Complaints</a>
          </li>
          <li class="nav-item d-none d-sm-inline-block">
        ...
        <div class="sidebar">
          ...
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="complaints?state=4&district=0&block=0&gp=0" class="nav-link active">
      ...
      <div class="content-wrapper" style="min-height: 217.667px">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Complaint Feeds</h1>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="/">Home</a></li>
                  <li class="breadcrumb-item active">Complaint Feeds Page</li>
                </ol>
              </div>
            </div>
          </div>
                  ...
                  <div class="card card-widget">
                    ...
                    <div class="card-body" style="display: block;">
                      @if($complaint->complaint_status_id == 0)
                        <strong class="text-muted">Complaint Status:</strong><i class="ml-2 fa fa-check-circle text-primary mr-1"></i>Resolved
                      @elseif($complaint->complaint_status_id != 0)
                        <strong class="text-muted">Complaint Status:</strong><i class="ml-2 fa fa-clock text-warning mr-1"></i>Pending
                      @endif
                      <p><strong class="text-muted">Complaint Type: </strong>
                        @php
